...
public class PrintingServiceImpl implements PrintingService {
    ...
    public void printSummary(final Summary summary) {
        ...
        msg.append(NEW_LINE);
        msg.append(OVERPAYMENT_PROVISION).append(summary.getOverpaymentProvisionSum()
                .setScale(2, RoundingMode.HALF_UP))
                .append(CURRENCY);
        msg.append(NEW_LINE);
        msg.append(LOSTS_SUM).append(summary.getTotalLostSum().setScale(2, RoundingMode.HALF_UP))
                .append(CURRENCY);
        msg.append(NEW_LINE);
        msg.append(CAPITAL_SUM).append(summary.getTotalCapital().setScale(2, RoundingMode.HALF_UP))
                .append(CURRENCY);
        msg.append(NEW_LINE);
